...
draw_sprite_ext(s_BallsText, 0, tween_x, tween_y, tween_xscale, tween_yscale, 0, c_white, tween_alpha);
...
x1 = tween_x - sprite_get_xoffset(s_BallsText);
y1 = tween_y - sprite_get_yoffset(s_BallsText);
x2 = x1 + sprite_get_width(s_BallsText);
y2 = y1 + sprite_get_height(s_BallsText);
