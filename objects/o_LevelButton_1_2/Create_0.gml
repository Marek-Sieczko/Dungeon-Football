...
//selected_level = rm_Level_2;
//global.LevelSelected = selected_level;

//Take start position
current_y_position = room_height - global.View_Height*0.4;

//Detect if level is locked
level_unlocked = o_LevelData.campaign_data.level_2.level_unlocked;
...
tween_y = room_height - global.View_Height*0.4;
tween_xscale = 1;
tween_yscale = 1;
tween_alpha = 1;
