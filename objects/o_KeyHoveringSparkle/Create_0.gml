...
part_type_size(global.pt_Effect1, 0.20, 0.50, 0, 0);
part_type_scale(global.pt_Effect1, 1, 1);
part_type_orientation(global.pt_Effect1, 0, 0, 0, 0, 0);
part_type_color3(global.pt_Effect1, 320255, 320255, 320255);
part_type_alpha3(global.pt_Effect1, 0, 0.50, 0);
part_type_blend(global.pt_Effect1, 1);
part_type_life(global.pt_Effect1, 80, 80);
part_type_speed(global.pt_Effect1, 0.30, 0.60, 0, 0);
