...
if (level_unlocked) { 
	...
	draw_sprite_ext(s_LevelButton_1_4, 0, tween_x, tween_y, tween_xscale, tween_yscale, 0, c_white, tween_alpha);
}
else {
...
x1 = tween_x - sprite_get_xoffset(s_LevelButton_1_4);
y1 = tween_y - sprite_get_yoffset(s_LevelButton_1_4);
x2 = x1 + sprite_get_width(s_LevelButton_1_4);
y2 = y1 + sprite_get_height(s_LevelButton_1_4);
...
if (_mouse_x >= x1) && (_mouse_x <= x2) && (_mouse_y >= y1) && (_mouse_y <= y2) {
	...
	if mouse_check_button_pressed(mb_any) && (can_click) && (level_unlocked) {
		...
		o_CampaignPanel.silver_time_attained = o_LevelData.campaign_data.level_4.silver_time_attained;
		o_CampaignPanel.silver_time_to_show = o_LevelData.campaign_data.level_4.silver_time;
		o_CampaignPanel.gold_time_attained = o_LevelData.campaign_data.level_4.gold_time_attained;
		o_CampaignPanel.gold_time_to_show = o_LevelData.campaign_data.level_4.gold_time;
		o_CampaignPanel.best_time_to_show = o_LevelData.campaign_data.level_4.best_time;
		o_CampaignPanel.level_rank_to_show = o_LevelData.campaign_data.level_4.level_rank;
...
var bronze_completion = o_LevelData.campaign_data.level_4.bronze_time_attained;
var silver_completion = o_LevelData.campaign_data.level_4.silver_time_attained;
var gold_completion = o_LevelData.campaign_data.level_4.gold_time_attained;
