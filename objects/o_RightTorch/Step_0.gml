...
if (particle_timer == 4)  && (can_spawn) {
	...
	xp = x;
	yp = y;
	part_emitter_region(global.ParticleSystem, global.pe_TorchFlame, xp-19, xp-15, yp-2, yp+2, ps_shape_rectangle, ps_distr_linear);
	part_emitter_stream(global.ParticleSystem, global.pe_TorchFlame, global.pt_TorchFlame, 1);
	part_emitter_region(global.ParticleSystem, global.pe_TorchSpark, xp-19, xp-15, yp-2, yp+2, ps_shape_rectangle, ps_distr_linear);
