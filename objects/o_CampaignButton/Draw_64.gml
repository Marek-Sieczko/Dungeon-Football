...
draw_sprite_ext(s_CampaignText, 0, tween_x, tween_y, tween_xscale, tween_yscale, 0, c_white, tween_alpha);
...
x1 = tween_x - sprite_get_xoffset(s_CampaignText);
y1 = tween_y - sprite_get_yoffset(s_CampaignText);
x2 = x1 + sprite_get_width(s_CampaignText);
y2 = y1 + sprite_get_height(s_CampaignText);
